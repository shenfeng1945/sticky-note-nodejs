...
/* WEBPACK VAR INJECTION */(function($) {function toast(msg, time,status) {
    this.msg = msg
...
let Toast = __webpack_require__(0).Toast;
...
let fetch = __webpack_require__(16).fetch;
let url = __webpack_require__(15).url;
...
var noteService = __webpack_require__(7);
let Toast = __webpack_require__(0).Toast;
let sortRank = __webpack_require__(8).sortRank;
let vue = new Vue({
    el: '#app',
    data: {
        noteLists: null,
...
/* WEBPACK VAR INJECTION */(function($) {let Toast = __webpack_require__(0).Toast;
